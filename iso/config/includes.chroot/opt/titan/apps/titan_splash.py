"""
TITAN V7.0.3 — Reusable Branded Splash Screen
...
def show_titan_splash(app: QApplication, subtitle: str = "OPERATION CENTER",
    ...
    try:
        ...
        # Orange accent dot at top center
        ...
        # TITAN title
        p.setPen(accent)
        p.setFont(QFont("JetBrains Mono", 30, QFont.Weight.Bold))
        p.drawText(0, 70, W, 55, Qt.AlignmentFlag.AlignCenter, "TITAN")

        # Version
        p.setFont(QFont("JetBrains Mono", 10))
        p.setPen(accent_dim)
        p.drawText(0, 125, W, 25, Qt.AlignmentFlag.AlignCenter, "V7.0.3  SINGULARITY")
