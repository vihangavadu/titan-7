...
class AutoPatcher:
    ...
    KNOWN_FIXES = {
        "incorrect_cvc": {
            "description": "CVV mismatch ΓÇö card data issue, not a code bug",
...
class BugReporterWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("TITAN V8.0 ΓÇö Diagnostic Reporter")
        try:
    ...
    # ΓöÇΓöÇ Tab: System Status (49-module health check) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

    def _build_system_status_tab(self) -> QWidget:
        """Tab 1: System Status ΓÇö 49 module health check, import tests, system info, dependency check."""
        w = QWidget()
    ...
    def _run_module_health_checks(self):
        ...
        self.health_status_lbl.setText(
            f"Status: Complete ΓÇö {passed} PASS / {failed} FAIL / {len(CORE_MODULES)} total"
        )

    # ΓöÇΓöÇ Tab: Bug Report (renamed from "New Report") ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

    # ΓöÇΓöÇ Tab: Module Inspector ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

    def _build_module_inspector_tab(self) -> QWidget:
        """Tab 3: Module Inspector ΓÇö browse modules, docstrings, test imports."""
        w = QWidget()
    ...
    def _test_selected_module_import(self):
        ...
        try:
            importlib.import_module(mod_name)
            QMessageBox.information(self, "Import Test", f"Γ£à {mod_name}: Import PASSED")
        except ImportError as e:
            QMessageBox.warning(self, "Import Test", f"Γ¥î {mod_name}: Import FAILED\n{e}")
        finally:
            _sys.path[:] = old_path

    # ΓöÇΓöÇ Tab: Logs ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

    def _build_logs_tab(self) -> QWidget:
        """Tab 4: Logs ΓÇö real-time log viewer with filter by module/severity and export."""
        w = QWidget()
        layout = QVBoxLayout(w)
    ...
    # ΓöÇΓöÇ Tab: Bug Report ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Tab: Reports List ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Tab: Decline Patterns ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Tab: Patches ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
